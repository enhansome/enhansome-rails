...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 498,506 | 🐛 104 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 47,845 | 🐛 76 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,236 | 🐛 4,498 | 🌐 Ruby | 📅 2026-08-21 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,692 | 🐛 252 | 🌐 Ruby | 📅 2026-08-21 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,039 | 🐛 1,347 | 🌐 Ruby | 📅 2026-08-21 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,535 | 🐛 37 | 🌐 Ruby | 📅 2026-08-21 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,769 | 🐛 131 | 🌐 Ruby | 📅 2026-08-20 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,315 | 🐛 118 | 🌐 Ruby | 📅 2026-08-17 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,750 | 🐛 88 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,906 | 🐛 203 | 🌐 Ruby | 📅 2026-08-21 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,779 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
...
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,582 | 🐛 48 | 🌐 Ruby | 📅 2026-08-21 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
...
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,812 | 🐛 652 | 🌐 Ruby | 📅 2026-08-20 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,786 | 🐛 487 | 🌐 Ruby | 📅 2026-08-19 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,591 | 🐛 90 | 🌐 Ruby | 📅 2026-08-21 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,439 | 🐛 115 | 🌐 Ruby | 📅 2026-08-21 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
...
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,195 | 🐛 140 | 🌐 Ruby | 📅 2026-08-21 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,023 | 🐛 42 | 🌐 Ruby | 📅 2026-08-21 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 843 | 🐛 549 | 🌐 JavaScript | 📅 2026-08-20 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 476 | 🐛 384 | 🌐 Ruby | 📅 2026-08-21 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 419 | 🐛 136 | 🌐 Ruby | 📅 2026-08-21 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 27 | 🌐 Ruby | 📅 2026-08-21 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 468 | 🌐 Ruby | 📅 2026-08-21 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [somleng](https://github.com/somleng/somleng) ⭐ 98 | 🐛 7 | 🌐 Ruby | 📅 2026-08-19 - An Open Source Communications-Platform-as-a-Service (CPaaS) and Telco-as-a-service (TaaS). (using Rails 7.1). - [:earth\_africa:](https://www.somleng.org)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,704 | 🐛 1,587 | 🌐 Ruby | 📅 2026-08-21 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)

> Other gems that can be used with Rails

* [devise](https://github.com/heartcombo/devise) ⭐ 24,356 | 🐛 230 | 🌐 Ruby | 📅 2026-06-22 - A gem to provide authentication. [:red\_circle:](https://rubygems.org/gems/devise)
* [spree](https://github.com/spree/spree) ⭐ 15,632 | 🐛 135 | 🌐 Ruby | 📅 2026-08-21 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
...
* [carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,780 | 🐛 70 | 🌐 Ruby | 📅 2026-06-22 - A gem to handle file uploads. [:red\_circle:](https://rubygems.org/gems/carrierwave)
...
* [rails\_admin](https://github.com/railsadminteam/rails_admin) ⭐ 7,957 | 🐛 202 | 🌐 Ruby | 📅 2026-08-08 - A gem to create & manage admin panel for Rails app. [:red\_circle:](https://rubygems.org/gems/rails_admin)
...
* [searchkick](https://github.com/ankane/searchkick) ⭐ 6,718 | 🐛 9 | 🌐 Ruby | 📅 2026-08-17 - A gem to provide search functionality. [:red\_circle:](https://rubygems.org/gems/searchkick)
...
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,520 | 🐛 17 | 🌐 Ruby | 📅 2026-08-20 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 63 | 🌐 Ruby | 📅 2026-08-20 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 130 | 🌐 Ruby | 📅 2026-08-21 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [view\_component](https://github.com/ViewComponent/view_component) ⭐ 3,570 | 🐛 4 | 🌐 Ruby | 📅 2026-08-20 - A gem to introduce view components. [:red\_circle:](https://rubygems.org/gems/view_component)
...
* [solid\_queue](https://github.com/basecamp/solid_queue) ⭐ 2,485 | 🐛 43 | 🌐 Ruby | 📅 2026-08-21 - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)
...
* [lockbox](https://github.com/ankane/lockbox) ⭐ 1,607 | 🐛 5 | 🌐 Ruby | 📅 2026-04-09 - A gem to deal with encryption. [:red\_circle:](https://rubygems.org/gems/lockbox)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,197 | 🐛 8 | 🌐 Ruby | 📅 2026-08-20 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
...
* [activerecord-sqlserver-adapter](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 981 | 🐛 23 | 🌐 Ruby | 📅 2026-08-07 - ActiveRecord connection adapter for the SQL Server. [:red\_circle:](https://rubygems.org/gems/activerecord-sqlserver-adapter)
...
* [rubocop-rails](https://github.com/rubocop/rubocop-rails) ⭐ 875 | 🐛 188 | 🌐 Ruby | 📅 2026-08-16 - A code style checking tool. [:red\_circle:](https://rubygems.org/gems/rubocop-rails)
...
* [tidewave](https://github.com/tidewave-ai/tidewave_rails) ⭐ 475 | 🐛 2 | 🌐 Ruby | 📅 2026-08-18 - MCP server for agentic Rails development, runtime-level tools for your agent to talk to your running app. [:red\_circle:](https://rubygems.org/gems/tidewave)
...
* [rails\_semantic\_logger](https://github.com/reidmorrison/rails_semantic_logger) ⭐ 423 | 🐛 0 | 🌐 Ruby | 📅 2026-08-18 - A gem to provide alternative logging approach for Rails app. [:red\_circle:](https://rubygems.org/gems/rails_semantic_logger)
...
* [rails\_api\_base](https://github.com/rootstrap/rails_api_base) ⭐ 632 | 🐛 5 | 🌐 Ruby | 📅 2026-08-14 - Rails 6 boilerplate project for JSON RESTful APIs.
