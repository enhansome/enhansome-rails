...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 501,672 | 🐛 105 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 48,281 | 🐛 85 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,259 | 🐛 4,515 | 🌐 Ruby | 📅 2026-08-31 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,763 | 🐛 269 | 🌐 Ruby | 📅 2026-08-31 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,340 | 🐛 1,351 | 🌐 Ruby | 📅 2026-08-31 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,552 | 🐛 36 | 🌐 Ruby | 📅 2026-08-31 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,774 | 🐛 131 | 🌐 Ruby | 📅 2026-08-31 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,411 | 🐛 121 | 🌐 Ruby | 📅 2026-08-31 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,776 | 🐛 95 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,981 | 🐛 230 | 🌐 Ruby | 📅 2026-08-31 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,792 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
...
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,599 | 🐛 51 | 🌐 Ruby | 📅 2026-08-31 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
...
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,171 | 🐛 110 | 🌐 Ruby | 📅 2026-08-31 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [selfstarter](https://github.com/apigy/selfstarter) ⭐ 3,154 | 🐛 47 | 🌐 Ruby | 📅 2022-10-27 - A crowdfunding app (using Rails 4.0).
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,817 | 🐛 659 | 🌐 Ruby | 📅 2026-08-31 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,795 | 🐛 467 | 🌐 Ruby | 📅 2026-08-31 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,593 | 🐛 99 | 🌐 Ruby | 📅 2026-08-31 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,439 | 🐛 112 | 🌐 Ruby | 📅 2026-08-31 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
...
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,204 | 🐛 138 | 🌐 Ruby | 📅 2026-08-27 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,026 | 🐛 41 | 🌐 Ruby | 📅 2026-08-31 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 849 | 🐛 548 | 🌐 JavaScript | 📅 2026-08-31 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
* [autolab](https://github.com/autolab/Autolab) ⭐ 810 | 🐛 189 | 🌐 Ruby | 📅 2026-08-22 - A course management app (using Rails 6.0). - [:earth\_africa:](https://autolabproject.com/)
...
* [human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 590 | 🐛 61 | 🌐 Ruby | 📅 2026-08-31 - An inventory management system for essentials banks (using Rails 7.0). - [:earth\_africa:](https://humanessentials.app/)
* [ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 489 | 🐛 9 | 🌐 Ruby | 📅 2026-08-27 - A farm management app (using Rails 5.0).
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 477 | 🐛 385 | 🌐 Ruby | 📅 2026-08-31 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
...
* [vglist](https://github.com/connorshea/vglist) ⭐ 159 | 🐛 60 | 🌐 Ruby | 📅 2026-08-31 - A video game library tracking web app (using Rails 7.0). - [:earth\_africa:](https://vglist.co/)
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 215 | 🌐 TypeScript | 📅 2026-08-31 - Learning platform app (using Rails 6.0).
...
* [planningalerts-app](https://github.com/openaustralia/planningalerts) ⭐ 115 | 🐛 61 | 🌐 Ruby | 📅 2026-08-31 - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 33 | 🌐 Ruby | 📅 2026-08-31 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,746 | 🐛 1,605 | 🌐 Ruby | 📅 2026-08-31 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)
...
* [spree](https://github.com/spree/spree) ⭐ 15,655 | 🐛 135 | 🌐 Ruby | 📅 2026-08-31 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
* [activeadmin](https://github.com/activeadmin/activeadmin) ⭐ 9,708 | 🐛 30 | 🌐 Ruby | 📅 2026-08-25 - A gem to provide admin panel. [:red\_circle:](https://rubygems.org/gems/activeadmin)
* [carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,776 | 🐛 50 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle file uploads. [:red\_circle:](https://rubygems.org/gems/carrierwave)
* [kaminari](https://github.com/kaminari/kaminari) ⭐ 8,671 | 🐛 74 | 🌐 Ruby | 📅 2026-02-20 - A gem to provide pagination. [:red\_circle:](https://rubygems.org/gems/kaminari)
...
* [better\_errors](https://github.com/BetterErrors/better_errors) ⭐ 6,862 | 🐛 69 | 🌐 Ruby | 📅 2024-07-09 - A tool to provide better error page. [:red\_circle:](https://rubygems.org/gems/better_errors)
...
* [cancancan](https://github.com/cancancommunity/cancancan) ⭐ 5,685 | 🐛 92 | 🌐 Ruby | 📅 2026-08-09 - A gem to handle authorization. [:red\_circle:](https://rubygems.org/gems/cancancan)
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,522 | 🐛 19 | 🌐 Ruby | 📅 2026-08-29 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,327 | 🐛 110 | 🌐 Ruby | 📅 2026-08-28 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 68 | 🌐 Ruby | 📅 2026-08-27 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 117 | 🌐 Ruby | 📅 2026-08-31 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [activerecord-import](https://github.com/zdennis/activerecord-import) ⭐ 4,156 | 🐛 53 | 🌐 Ruby | 📅 2026-08-28 - A gem to handle bulk data insertion using ActiveRecord. [:red\_circle:](https://rubygems.org/gems/activerecord-import)
...
* [good\_job](https://github.com/bensheldon/good_job) ⭐ 2,993 | 🐛 128 | 🌐 Ruby | 📅 2026-08-15 - A gem to provide Postgres-based ActiveJob backend. [:red\_circle:](https://rubygems.org/gems/good_job)
...
* [solid\_queue](https://github.com/basecamp/solid_queue) ⭐ 2,490 | 🐛 19 | 🌐 Ruby | 📅 2026-08-31 - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)
...
* [avo](https://github.com/avo-hq/avo) ⭐ 1,799 | 🐛 195 | 🌐 Ruby | 📅 2026-08-31 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,200 | 🐛 8 | 🌐 Ruby | 📅 2026-08-31 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
...
* [stimulus-rails](https://github.com/hotwired/stimulus-rails) ⭐ 728 | 🐛 12 | 🌐 JavaScript | 📅 2025-03-03 - A gem to integrate Stimulus.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/stimulus-rails)
...
* [algoliasearch-rails](https://github.com/algolia/algoliasearch-rails) ⭐ 419 | 🐛 61 | 🌐 Ruby | 📅 2026-08-31 - A gem to integrate Algolia search. [:red\_circle:](https://rubygems.org/gems/algoliasearch-rails)
...
* [rails\_api\_base](https://github.com/rootstrap/rails_api_base) ⭐ 632 | 🐛 5 | 🌐 Ruby | 📅 2026-08-28 - Rails 6 boilerplate project for JSON RESTful APIs.
