...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 495,983 | 🐛 100 | 📅 2026-06-30
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 47,566 | 🐛 75 | 📅 2026-05-08
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,207 | 🐛 4,490 | 🌐 Ruby | 📅 2026-08-15 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,654 | 🐛 235 | 🌐 Ruby | 📅 2026-08-15 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 35,886 | 🐛 1,337 | 🌐 Ruby | 📅 2026-08-14 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,530 | 🐛 37 | 🌐 Ruby | 📅 2026-08-15 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,765 | 🐛 119 | 🌐 Ruby | 📅 2026-08-15 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,259 | 🐛 117 | 🌐 Ruby | 📅 2026-08-11 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,735 | 🐛 90 | 🌐 Ruby | 📅 2026-08-05 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,851 | 🐛 214 | 🌐 Ruby | 📅 2026-08-15 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,772 | 🐛 466 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,814 | 🐛 260 | 🌐 Ruby | 📅 2026-08-15 - A link aggregation app (using Rails 7.0). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,572 | 🐛 61 | 🌐 Ruby | 📅 2026-08-12 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
...
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,151 | 🐛 127 | 🌐 Ruby | 📅 2026-08-14 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,806 | 🐛 654 | 🌐 Ruby | 📅 2026-08-13 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,437 | 🐛 110 | 🌐 Ruby | 📅 2026-08-14 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,175 | 🐛 129 | 🌐 Ruby | 📅 2026-08-14 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [ciao](https://github.com/brotandgames/ciao) ⭐ 1,974 | 🐛 2 | 🌐 Ruby | 📅 2026-07-16 - A URL status checking app (using Rails 6.0).
...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,669 | 🐛 165 | 🌐 Ruby | 📅 2026-08-15- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 476 | 🐛 389 | 🌐 Ruby | 📅 2026-08-14 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 33 | 🌐 Ruby | 📅 2026-08-14 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-15 - Learning platform app (using Rails 6.0).
...
* [beatstream](https://github.com/Darep/Beatstream) ⭐ 124 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-15 - A music streaming app - using Rails 3.2
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,685 | 🐛 1,592 | 🌐 Ruby | 📅 2026-08-15 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)
...
* [spree](https://github.com/spree/spree) ⭐ 15,622 | 🐛 133 | 🌐 Ruby | 📅 2026-08-15 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,261 | 🐛 110 | 🌐 Ruby | 📅 2026-08-13 - A gem to scan code against security vulnerabilities. [:red\_circle:](https://rubygems.org/gems/brakeman)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 136 | 🌐 Ruby | 📅 2026-08-15 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [groupdate](https://github.com/ankane/groupdate) ⭐ 3,887 | 🐛 2 | 🌐 Ruby | 📅 2026-06-29 - A gem to manage temporal data. [:red\_circle:](https://rubygems.org/gems/groupdate)
...
* [apipie-rails](https://github.com/apipie/apipie-rails) ⭐ 2,508 | 🐛 234 | 🌐 Ruby | 📅 2026-06-26 - A REST API documentation tool. [:red\_circle:](https://rubygems.org/gems/apipie-rails)
...
* [rubocop-rails](https://github.com/rubocop/rubocop-rails) ⭐ 876 | 🐛 187 | 🌐 Ruby | 📅 2026-08-14 - A code style checking tool. [:red\_circle:](https://rubygems.org/gems/rubocop-rails)
...
* [rodauth-rails](https://github.com/janko/rodauth-rails) ⭐ 758 | 🐛 0 | 🌐 HTML | 📅 2026-08-07 - A gem to wrap Rodauth, an authentication handler, for Rails apps. [:red\_circle:](https://rubygems.org/gems/rodauth-rails)
...
* [tidewave](https://github.com/tidewave-ai/tidewave_rails) ⭐ 475 | 🐛 2 | 🌐 Ruby | 📅 2026-08-05 - MCP server for agentic Rails development, runtime-level tools for your agent to talk to your running app. [:red\_circle:](https://rubygems.org/gems/tidewave)
...
* [rollup](https://github.com/ankane/rollup) ⭐ 352 | 🐛 3 | 🌐 Ruby | 📅 2026-06-29 -  A gem to handle time-series data in Rails [:red\_circle:](https://rubygems.org/gems/rollups)
