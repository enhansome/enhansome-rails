...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,669 | 🐛 163 | 🌐 Ruby | 📅 2026-08-13- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [good\_job](https://github.com/bensheldon/good_job) ⭐ 2,991 | 🐛 126 | 🌐 Ruby | 📅 2026-08-04 - A gem to provide Postgres-based ActiveJob backend. [:red\_circle:](https://rubygems.org/gems/good_job)
...
* [stimulus-rails](https://github.com/hotwired/stimulus-rails) ⭐ 725 | 🐛 10 | 🌐 JavaScript | 📅 2025-03-03 - A gem to integrate Stimulus.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/stimulus-rails)
