...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 501,377 | 🐛 105 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 48,250 | 🐛 85 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,260 | 🐛 4,512 | 🌐 Ruby | 📅 2026-08-30 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,761 | 🐛 287 | 🌐 Ruby | 📅 2026-08-29 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,310 | 🐛 1,354 | 🌐 Ruby | 📅 2026-08-29 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,547 | 🐛 36 | 🌐 Ruby | 📅 2026-08-30 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,773 | 🐛 130 | 🌐 Ruby | 📅 2026-08-30 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,405 | 🐛 120 | 🌐 Ruby | 📅 2026-08-25 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,774 | 🐛 90 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,971 | 🐛 227 | 🌐 Ruby | 📅 2026-08-30 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
* [diaspora](https://github.com/diaspora/diaspora) ⭐ 13,654 | 🐛 425 | 🌐 Ruby | 📅 2026-07-28 - A social networking app - using Rails 6.1 - [:earth\_africa:](https://diasporafoundation.org)
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,791 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,820 | 🐛 265 | 🌐 Ruby | 📅 2026-08-17 - A link aggregation app (using Rails 8.1). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,596 | 🐛 51 | 🌐 Ruby | 📅 2026-08-27 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
* [blackCandy](https://github.com/blackcandy-org/black_candy) ⭐ 4,408 | 🐛 33 | 🌐 Ruby | 📅 2026-08-30 - A music streaming app (using Rails 7.0).
...
* [fat-free-crm](https://github.com/fatfreecrm/fat_free_crm) ⭐ 3,629 | 🐛 72 | 🌐 Ruby | 📅 2026-08-26 - An open source, Ruby on Rails customer relationship management platform (CRM) (using Rails 6.1). - [:earth\_africa:](http://www.fatfreecrm.com/)
* [peatio](https://github.com/peatio/peatio) ⭐ 3,600 | 🐛 302 | 🌐 Ruby | 📅 2026-07-09 - A crypto currency exchange app (using Rails 4.0).
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,171 | 🐛 113 | 🌐 Ruby | 📅 2026-08-28 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [selfstarter](https://github.com/apigy/selfstarter) ⭐ 3,154 | 🐛 47 | 🌐 Ruby | 📅 2022-10-27 - A crowdfunding app (using Rails 4.0).
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,816 | 🐛 655 | 🌐 Ruby | 📅 2026-08-28 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,795 | 🐛 470 | 🌐 Ruby | 📅 2026-08-29 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,593 | 🐛 95 | 🌐 Ruby | 📅 2026-08-29 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,439 | 🐛 115 | 🌐 Ruby | 📅 2026-08-30 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
...
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,204 | 🐛 136 | 🌐 Ruby | 📅 2026-08-27 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [publify](https://github.com/publify/publify) ⭐ 1,855 | 🐛 84 | 🌐 Less | 📅 2026-08-28 - A blogging app (using Rails 6.1).
...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,673 | 🐛 175 | 🌐 Ruby | 📅 2026-08-29- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,026 | 🐛 37 | 🌐 Ruby | 📅 2026-08-28 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 849 | 🐛 548 | 🌐 JavaScript | 📅 2026-08-29 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 590 | 🐛 61 | 🌐 Ruby | 📅 2026-08-30 - An inventory management system for essentials banks (using Rails 7.0). - [:earth\_africa:](https://humanessentials.app/)
* [ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 489 | 🐛 9 | 🌐 Ruby | 📅 2026-08-27 - A farm management app (using Rails 5.0).
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 477 | 🐛 384 | 🌐 Ruby | 📅 2026-08-28 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
* [growstuff](https://github.com/Growstuff/growstuff) ⭐ 473 | 🐛 120 | 🌐 Ruby | 📅 2026-08-28 - A data management app for food gardeners (using Rails 6.1). - [:earth\_africa:](https://www.growstuff.org/)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 418 | 🐛 139 | 🌐 Ruby | 📅 2026-08-28 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 27 | 🌐 Ruby | 📅 2026-08-28 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 475 | 🌐 Ruby | 📅 2026-08-30 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [vglist](https://github.com/connorshea/vglist) ⭐ 159 | 🐛 72 | 🌐 Ruby | 📅 2026-08-27 - A video game library tracking web app (using Rails 7.0). - [:earth\_africa:](https://vglist.co/)
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 214 | 🌐 TypeScript | 📅 2026-08-30 - Learning platform app (using Rails 6.0).
...
* [beatstream](https://github.com/Darep/Beatstream) ⭐ 124 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-30 - A music streaming app - using Rails 3.2
* [planningalerts-app](https://github.com/openaustralia/planningalerts) ⭐ 115 | 🐛 62 | 🌐 Ruby | 📅 2026-08-29 - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
* [somleng](https://github.com/somleng/somleng) ⭐ 97 | 🐛 7 | 🌐 Ruby | 📅 2026-08-28 - An Open Source Communications-Platform-as-a-Service (CPaaS) and Telco-as-a-service (TaaS). (using Rails 7.1). - [:earth\_africa:](https://www.somleng.org)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 33 | 🌐 Ruby | 📅 2026-08-27 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,743 | 🐛 1,611 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)

> Other gems that can be used with Rails

* [devise](https://github.com/heartcombo/devise) ⭐ 24,357 | 🐛 233 | 🌐 Ruby | 📅 2026-06-22 - A gem to provide authentication. [:red\_circle:](https://rubygems.org/gems/devise)
* [spree](https://github.com/spree/spree) ⭐ 15,652 | 🐛 132 | 🌐 Ruby | 📅 2026-08-30 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
* [activeadmin](https://github.com/activeadmin/activeadmin) ⭐ 9,707 | 🐛 30 | 🌐 Ruby | 📅 2026-08-25 - A gem to provide admin panel. [:red\_circle:](https://rubygems.org/gems/activeadmin)
* [carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,778 | 🐛 50 | 🌐 Ruby | 📅 2026-08-30 - A gem to handle file uploads. [:red\_circle:](https://rubygems.org/gems/carrierwave)
...
* [rails\_admin](https://github.com/railsadminteam/rails_admin) ⭐ 7,957 | 🐛 202 | 🌐 Ruby | 📅 2026-08-30 - A gem to create & manage admin panel for Rails app. [:red\_circle:](https://rubygems.org/gems/rails_admin)
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,265 | 🐛 115 | 🌐 Ruby | 📅 2026-08-13 - A gem to scan code against security vulnerabilities. [:red\_circle:](https://rubygems.org/gems/brakeman)
...
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,521 | 🐛 19 | 🌐 Ruby | 📅 2026-08-29 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,324 | 🐛 109 | 🌐 Ruby | 📅 2026-08-28 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,270 | 🐛 68 | 🌐 Ruby | 📅 2026-08-27 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 121 | 🌐 Ruby | 📅 2026-08-30 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [solid\_queue](https://github.com/basecamp/solid_queue) ⭐ 2,489 | 🐛 23 | 🌐 Ruby | 📅 2026-08-30 - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)
...
* [avo](https://github.com/avo-hq/avo) ⭐ 1,799 | 🐛 201 | 🌐 Ruby | 📅 2026-08-30 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [aggregate\_root](https://github.com/RailsEventStore/rails_event_store/tree/master/aggregate_root) ⭐ 1,552 | 🐛 15 | 🌐 Ruby | 📅 2026-08-27 - A gem to handle event sourcing. [:red\_circle:](https://rubygems.org/gems/aggregate_root)
* [rails\_event\_store](https://github.com/RailsEventStore/rails_event_store) ⭐ 1,552 | 🐛 15 | 🌐 Ruby | 📅 2026-08-27 - A gem to implement event store in Rails [:red\_circle:](https://rubygems.org/gems/rails_event_store)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,200 | 🐛 7 | 🌐 Ruby | 📅 2026-08-28 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
...
* [sprockets](https://github.com/rails/sprockets) ⭐ 986 | 🐛 119 | 🌐 Ruby | 📅 2026-08-25 - A gem to compile & serve web assets. [:red\_circle:](https://rubygems.org/gems/sprockets)
* [activerecord-sqlserver-adapter](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 981 | 🐛 21 | 🌐 Ruby | 📅 2026-08-29 - ActiveRecord connection adapter for the SQL Server. [:red\_circle:](https://rubygems.org/gems/activerecord-sqlserver-adapter)
* [mailkick](https://github.com/ankane/mailkick) ⭐ 976 | 🐛 1 | 🌐 Ruby | 📅 2026-08-08 - A tool to handle mail unsubscriptions. [:red\_circle:](https://rubygems.org/gems/mailkick)
...
* [algoliasearch-rails](https://github.com/algolia/algoliasearch-rails) ⭐ 419 | 🐛 61 | 🌐 Ruby | 📅 2026-08-26 - A gem to integrate Algolia search. [:red\_circle:](https://rubygems.org/gems/algoliasearch-rails)
...
* [rails\_api\_base](https://github.com/rootstrap/rails_api_base) ⭐ 633 | 🐛 5 | 🌐 Ruby | 📅 2026-08-28 - Rails 6 boilerplate project for JSON RESTful APIs.
