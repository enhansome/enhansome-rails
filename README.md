...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 496,819 | 🐛 100 | 📅 2026-06-30
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 47,597 | 🐛 75 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,217 | 🐛 4,483 | 🌐 Ruby | 📅 2026-08-17 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,665 | 🐛 236 | 🌐 Ruby | 📅 2026-08-17 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 35,919 | 🐛 1,338 | 🌐 Ruby | 📅 2026-08-17 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,532 | 🐛 37 | 🌐 Ruby | 📅 2026-08-17 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,769 | 🐛 127 | 🌐 Ruby | 📅 2026-08-17 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,264 | 🐛 118 | 🌐 Ruby | 📅 2026-08-17 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,739 | 🐛 90 | 🌐 Ruby | 📅 2026-08-05 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,866 | 🐛 221 | 🌐 Ruby | 📅 2026-08-17 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,815 | 🐛 261 | 🌐 Ruby | 📅 2026-08-15 - A link aggregation app (using Rails 7.0). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,576 | 🐛 61 | 🌐 Ruby | 📅 2026-08-12 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
...
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,154 | 🐛 135 | 🌐 Ruby | 📅 2026-08-17 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
...
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,783 | 🐛 494 | 🌐 Ruby | 📅 2026-08-17 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,590 | 🐛 92 | 🌐 Ruby | 📅 2026-08-17 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,438 | 🐛 110 | 🌐 Ruby | 📅 2026-08-17 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,182 | 🐛 134 | 🌐 Ruby | 📅 2026-08-14 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [publify](https://github.com/publify/publify) ⭐ 1,857 | 🐛 84 | 🌐 Less | 📅 2026-08-17 - A blogging app (using Rails 6.1).
...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,670 | 🐛 166 | 🌐 Ruby | 📅 2026-08-15- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,022 | 🐛 44 | 🌐 Ruby | 📅 2026-08-17 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 844 | 🐛 549 | 🌐 JavaScript | 📅 2026-08-16 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [hackershare](https://github.com/hackershare/hackershare) ⭐ 662 | 🐛 14 | 🌐 HTML | 📅 2024-06-18 - Social bookmarks website for hackers (using Rails 7.0). - [:earth\_africa:](https://hackershare.dev/en)
...
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 476 | 🐛 383 | 🌐 Ruby | 📅 2026-08-17 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
* [growstuff](https://github.com/Growstuff/growstuff) ⭐ 473 | 🐛 120 | 🌐 Ruby | 📅 2026-08-17 - A data management app for food gardeners (using Rails 6.1). - [:earth\_africa:](https://www.growstuff.org/)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 419 | 🐛 131 | 🌐 Ruby | 📅 2026-08-17 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 34 | 🌐 Ruby | 📅 2026-08-17 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 474 | 🌐 Ruby | 📅 2026-08-16 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-17 - Learning platform app (using Rails 6.0).
...
* [planningalerts-app](https://github.com/openaustralia/planningalerts) ⭐ 115 | 🐛 70 | 🌐 Ruby | 📅 2026-08-17 - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
* [somleng](https://github.com/somleng/somleng) ⭐ 98 | 🐛 7 | 🌐 Ruby | 📅 2026-08-14 - An Open Source Communications-Platform-as-a-Service (CPaaS) and Telco-as-a-service (TaaS). (using Rails 7.1). - [:earth\_africa:](https://www.somleng.org)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 32 | 🌐 Ruby | 📅 2026-08-14 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,688 | 🐛 1,588 | 🌐 Ruby | 📅 2026-08-17 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)
...
* [spree](https://github.com/spree/spree) ⭐ 15,624 | 🐛 133 | 🌐 Ruby | 📅 2026-08-17 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
* [activeadmin](https://github.com/activeadmin/activeadmin) ⭐ 9,705 | 🐛 30 | 🌐 Ruby | 📅 2026-08-11 - A gem to provide admin panel. [:red\_circle:](https://rubygems.org/gems/activeadmin)
...
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,262 | 🐛 110 | 🌐 Ruby | 📅 2026-08-13 - A gem to scan code against security vulnerabilities. [:red\_circle:](https://rubygems.org/gems/brakeman)
...
* [friendly\_id](https://github.com/norman/friendly_id) ⭐ 6,226 | 🐛 35 | 🌐 Ruby | 📅 2026-08-15 - A gem to deal with slugs & permalinks. [:red\_circle:](https://rubygems.org/gems/friendly_id)
...
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,519 | 🐛 18 | 🌐 Ruby | 📅 2026-08-17 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,319 | 🐛 108 | 🌐 Ruby | 📅 2026-08-17 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,272 | 🐛 62 | 🌐 Ruby | 📅 2026-06-23 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 129 | 🌐 Ruby | 📅 2026-08-17 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [view\_component](https://github.com/ViewComponent/view_component) ⭐ 3,569 | 🐛 5 | 🌐 Ruby | 📅 2026-08-12 - A gem to introduce view components. [:red\_circle:](https://rubygems.org/gems/view_component)
...
* [good\_job](https://github.com/bensheldon/good_job) ⭐ 2,990 | 🐛 127 | 🌐 Ruby | 📅 2026-08-15 - A gem to provide Postgres-based ActiveJob backend. [:red\_circle:](https://rubygems.org/gems/good_job)
...
* [solid\_queue](https://github.com/basecamp/solid_queue) ⭐ 2,484 | 🐛 51 | 🌐 Ruby | 📅 2026-07-31 - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)
...
* [avo](https://github.com/avo-hq/avo) ⭐ 1,797 | 🐛 236 | 🌐 Ruby | 📅 2026-08-17 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [lockbox](https://github.com/ankane/lockbox) ⭐ 1,606 | 🐛 5 | 🌐 Ruby | 📅 2026-04-09 - A gem to deal with encryption. [:red\_circle:](https://rubygems.org/gems/lockbox)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,196 | 🐛 8 | 🌐 Ruby | 📅 2026-08-17 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
...
* [sprockets](https://github.com/rails/sprockets) ⭐ 985 | 🐛 90 | 🌐 Ruby | 📅 2026-08-12 - A gem to compile & serve web assets. [:red\_circle:](https://rubygems.org/gems/sprockets)
...
* [tidewave](https://github.com/tidewave-ai/tidewave_rails) ⭐ 475 | 🐛 3 | 🌐 Ruby | 📅 2026-08-17 - MCP server for agentic Rails development, runtime-level tools for your agent to talk to your running app. [:red\_circle:](https://rubygems.org/gems/tidewave)
...
* [metka](https://github.com/jetrockets/metka) ⭐ 53 | 🐛 8 | 🌐 Ruby | 📅 2023-03-08 - A gem to manage tags using Postgresql array columns. [:red\_circle:](https://rubygems.org/gems/metka)
...
* [rails-template(ackama)](https://github.com/ackama/rails-template) ⭐ 383 | 🐛 33 | 🌐 Ruby | 📅 2026-08-10 - Application template for Rails 6.1 projects; preloaded with best practices for TDD, security, deployment, and developer productivity.
