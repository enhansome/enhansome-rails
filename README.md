...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 500,096 | 🐛 105 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 48,058 | 🐛 84 | 📅 2026-08-16
...
* [Implement SSR with React + Rails](https://github.com/shakacode/react_on_rails_demo_ssr_hmr) ⭐ 94 | 🐛 11 | 🌐 Ruby | 📅 2026-08-11
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,254 | 🐛 4,499 | 🌐 Ruby | 📅 2026-08-26 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,735 | 🐛 276 | 🌐 Ruby | 📅 2026-08-26 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,232 | 🐛 1,357 | 🌐 Ruby | 📅 2026-08-26 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,539 | 🐛 36 | 🌐 Ruby | 📅 2026-08-26 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,771 | 🐛 132 | 🌐 Ruby | 📅 2026-08-25 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,384 | 🐛 119 | 🌐 Ruby | 📅 2026-08-25 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,768 | 🐛 89 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,937 | 🐛 219 | 🌐 Ruby | 📅 2026-08-26 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,782 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,818 | 🐛 265 | 🌐 Ruby | 📅 2026-08-17 - A link aggregation app (using Rails 8.1). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,589 | 🐛 53 | 🌐 Ruby | 📅 2026-08-24 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
* [blackCandy](https://github.com/blackcandy-org/black_candy) ⭐ 4,404 | 🐛 33 | 🌐 Ruby | 📅 2026-08-26 - A music streaming app (using Rails 7.0).
* [feedbin](https://github.com/feedbin/feedbin) ⭐ 3,778 | 🐛 181 | 🌐 Ruby | 📅 2026-08-25 - A RSS reader app (using Rails 7.0). - [:earth\_africa:](https://feedbin.com)
* [fat-free-crm](https://github.com/fatfreecrm/fat_free_crm) ⭐ 3,628 | 🐛 72 | 🌐 Ruby | 📅 2026-08-26 - An open source, Ruby on Rails customer relationship management platform (CRM) (using Rails 6.1). - [:earth\_africa:](http://www.fatfreecrm.com/)
* [peatio](https://github.com/peatio/peatio) ⭐ 3,600 | 🐛 302 | 🌐 Ruby | 📅 2026-07-09 - A crypto currency exchange app (using Rails 4.0).
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,169 | 🐛 112 | 🌐 Ruby | 📅 2026-08-25 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [selfstarter](https://github.com/apigy/selfstarter) ⭐ 3,153 | 🐛 47 | 🌐 Ruby | 📅 2022-10-27 - A crowdfunding app (using Rails 4.0).
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,813 | 🐛 655 | 🌐 Ruby | 📅 2026-08-24 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,792 | 🐛 480 | 🌐 Ruby | 📅 2026-08-25 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,592 | 🐛 93 | 🌐 Ruby | 📅 2026-08-26 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
* [helpy](https://github.com/helpyio/helpy) ⭐ 2,472 | 🐛 230 | 🌐 Ruby | 📅 2023-03-08 - A customer support app (using Rails 4.2). - [:earth\_africa:](https://helpy.io/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,437 | 🐛 115 | 🌐 Ruby | 📅 2026-08-26 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,197 | 🐛 130 | 🌐 Ruby | 📅 2026-08-26 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [publify](https://github.com/publify/publify) ⭐ 1,855 | 🐛 84 | 🌐 Less | 📅 2026-08-24 - A blogging app (using Rails 6.1).
...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,671 | 🐛 170 | 🌐 Ruby | 📅 2026-08-26- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [codetriage](https://github.com/codetriage/codetriage) ⭐ 1,465 | 🐛 103 | 🌐 Ruby | 📅 2026-08-02 - An open source project finder app (using Rails 7.0). - [:earth\_africa:](https://www.codetriage.com/)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,024 | 🐛 36 | 🌐 Ruby | 📅 2026-08-26 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [FAE](https://github.com/wearefine/fae/) ⭐ 852 | 🐛 13 | 🌐 Ruby | 📅 2026-08-26 - A modern CMS developed by FINE (using Rails 5.2)
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 848 | 🐛 551 | 🌐 JavaScript | 📅 2026-08-25 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
* [autolab](https://github.com/autolab/Autolab) ⭐ 809 | 🐛 189 | 🌐 Ruby | 📅 2026-08-22 - A course management app (using Rails 6.0). - [:earth\_africa:](https://autolabproject.com/)
* [adopt-a-hydrant](https://github.com/codeforamerica/adopt-a-hydrant) ⭐ 792 | 🐛 30 | 🌐 Ruby | 📅 2023-09-26 - A civic infrastructure detection app (using Rails 4.2).
...
* [human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 583 | 🐛 75 | 🌐 Ruby | 📅 2026-08-26 - An inventory management system for essentials banks (using Rails 7.0). - [:earth\_africa:](https://humanessentials.app/)
* [ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 489 | 🐛 9 | 🌐 Ruby | 📅 2026-07-26 - A farm management app (using Rails 5.0).
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 476 | 🐛 389 | 🌐 Ruby | 📅 2026-08-26 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
* [growstuff](https://github.com/Growstuff/growstuff) ⭐ 473 | 🐛 120 | 🌐 Ruby | 📅 2026-08-24 - A data management app for food gardeners (using Rails 6.1). - [:earth\_africa:](https://www.growstuff.org/)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 418 | 🐛 141 | 🌐 Ruby | 📅 2026-08-26 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 28 | 🌐 Ruby | 📅 2026-08-24 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 479 | 🌐 Ruby | 📅 2026-08-25 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 218 | 🌐 TypeScript | 📅 2026-08-26 - Learning platform app (using Rails 6.0).
* [vglist](https://github.com/connorshea/vglist) ⭐ 157 | 🐛 71 | 🌐 Ruby | 📅 2026-08-25 - A video game library tracking web app (using Rails 7.0). - [:earth\_africa:](https://vglist.co/)
...
* [beatstream](https://github.com/Darep/Beatstream) ⭐ 124 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-24 - A music streaming app - using Rails 3.2
* [planningalerts-app](https://github.com/openaustralia/planningalerts) ⭐ 115 | 🐛 63 | 🌐 Ruby | 📅 2026-08-26 - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
* [somleng](https://github.com/somleng/somleng) ⭐ 98 | 🐛 7 | 🌐 Ruby | 📅 2026-08-24 - An Open Source Communications-Platform-as-a-Service (CPaaS) and Telco-as-a-service (TaaS). (using Rails 7.1). - [:earth\_africa:](https://www.somleng.org)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 32 | 🌐 Ruby | 📅 2026-08-25 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,719 | 🐛 1,598 | 🌐 Ruby | 📅 2026-08-26 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)

> Other gems that can be used with Rails

* [devise](https://github.com/heartcombo/devise) ⭐ 24,358 | 🐛 231 | 🌐 Ruby | 📅 2026-06-22 - A gem to provide authentication. [:red\_circle:](https://rubygems.org/gems/devise)
* [spree](https://github.com/spree/spree) ⭐ 15,645 | 🐛 131 | 🌐 Ruby | 📅 2026-08-26 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
* [activeadmin](https://github.com/activeadmin/activeadmin) ⭐ 9,705 | 🐛 29 | 🌐 Ruby | 📅 2026-08-25 - A gem to provide admin panel. [:red\_circle:](https://rubygems.org/gems/activeadmin)
* [carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,779 | 🐛 62 | 🌐 Ruby | 📅 2026-08-23 - A gem to handle file uploads. [:red\_circle:](https://rubygems.org/gems/carrierwave)
* [kaminari](https://github.com/kaminari/kaminari) ⭐ 8,672 | 🐛 74 | 🌐 Ruby | 📅 2026-02-20 - A gem to provide pagination. [:red\_circle:](https://rubygems.org/gems/kaminari)
...
* [rails\_admin](https://github.com/railsadminteam/rails_admin) ⭐ 7,957 | 🐛 202 | 🌐 Ruby | 📅 2026-08-22 - A gem to create & manage admin panel for Rails app. [:red\_circle:](https://rubygems.org/gems/rails_admin)
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,262 | 🐛 114 | 🌐 Ruby | 📅 2026-08-13 - A gem to scan code against security vulnerabilities. [:red\_circle:](https://rubygems.org/gems/brakeman)
...
* [friendly\_id](https://github.com/norman/friendly_id) ⭐ 6,225 | 🐛 30 | 🌐 Ruby | 📅 2026-08-18 - A gem to deal with slugs & permalinks. [:red\_circle:](https://rubygems.org/gems/friendly_id)
...
* [cancancan](https://github.com/cancancommunity/cancancan) ⭐ 5,686 | 🐛 92 | 🌐 Ruby | 📅 2026-08-09 - A gem to handle authorization. [:red\_circle:](https://rubygems.org/gems/cancancan)
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,521 | 🐛 19 | 🌐 Ruby | 📅 2026-08-26 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,322 | 🐛 119 | 🌐 Ruby | 📅 2026-08-26 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,270 | 🐛 65 | 🌐 Ruby | 📅 2026-08-22 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
* [formtastic](https://github.com/formtastic/formtastic) ⭐ 5,216 | 🐛 6 | 🌐 Ruby | 📅 2026-02-28 - A Rails form builder gem with semantically rich and accessible markup. [:red\_circle:](https://rubygems.org/gems/formtastic)
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 128 | 🌐 Ruby | 📅 2026-08-26 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
* [annotate](https://github.com/ctran/annotate_models) ⭐ 4,484 | 🐛 144 | 🌐 Ruby | 📅 2024-08-05 - A gem to annotate rails classes with schema & routes info. [:red\_circle:](https://rubygems.org/gems/annotate)
* [activerecord-import](https://github.com/zdennis/activerecord-import) ⭐ 4,154 | 🐛 44 | 🌐 Ruby | 📅 2026-08-24 - A gem to handle bulk data insertion using ActiveRecord. [:red\_circle:](https://rubygems.org/gems/activerecord-import)
* [rails-erd](https://github.com/voormedia/rails-erd) ⭐ 4,105 | 🐛 6 | 🌐 Ruby | 📅 2026-08-14 - A gem to generate entity-relationship diagram. [:red\_circle:](https://rubygems.org/gems/rails-erd)
* [groupdate](https://github.com/ankane/groupdate) ⭐ 3,887 | 🐛 2 | 🌐 Ruby | 📅 2026-08-15 - A gem to manage temporal data. [:red\_circle:](https://rubygems.org/gems/groupdate)
...
* [view\_component](https://github.com/ViewComponent/view_component) ⭐ 3,568 | 🐛 1 | 🌐 Ruby | 📅 2026-08-25 - A gem to introduce view components. [:red\_circle:](https://rubygems.org/gems/view_component)
* [factory\_bot\_rails](https://github.com/thoughtbot/factory_bot_rails) ⭐ 3,137 | 🐛 8 | 🌐 Ruby | 📅 2026-07-21 - A fixture replacement for testing in Rails [:red\_circle:](https://rubygems.org/gems/factory_bot_rails)
* [good\_job](https://github.com/bensheldon/good_job) ⭐ 2,993 | 🐛 127 | 🌐 Ruby | 📅 2026-08-15 - A gem to provide Postgres-based ActiveJob backend. [:red\_circle:](https://rubygems.org/gems/good_job)
* [spring](https://github.com/rails/spring) ⭐ 2,814 | 🐛 55 | 🌐 Ruby | 📅 2026-06-30 - A gem to preload Rails app. [:red\_circle:](https://rubygems.org/gems/spring)
* [apipie-rails](https://github.com/apipie/apipie-rails) ⭐ 2,507 | 🐛 234 | 🌐 Ruby | 📅 2026-06-26 - A REST API documentation tool. [:red\_circle:](https://rubygems.org/gems/apipie-rails)
* [solid\_queue](https://github.com/basecamp/solid_queue) ⭐ 2,488 | 🐛 42 | 🌐 Ruby | 📅 2026-08-23 - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)
...
* [avo](https://github.com/avo-hq/avo) ⭐ 1,797 | 🐛 196 | 🌐 Ruby | 📅 2026-08-26 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [lockbox](https://github.com/ankane/lockbox) ⭐ 1,609 | 🐛 5 | 🌐 Ruby | 📅 2026-04-09 - A gem to deal with encryption. [:red\_circle:](https://rubygems.org/gems/lockbox)
...
* [action\_policy](https://github.com/palkan/action_policy) ⭐ 1,560 | 🐛 6 | 🌐 Ruby | 📅 2026-07-25 - A tool to handle authorization. [:red\_circle:](https://rubygems.org/gems/action_policy)
* [aggregate\_root](https://github.com/RailsEventStore/rails_event_store/tree/master/aggregate_root) ⭐ 1,551 | 🐛 14 | 🌐 Ruby | 📅 2026-08-26 - A gem to handle event sourcing. [:red\_circle:](https://rubygems.org/gems/aggregate_root)
* [rails\_event\_store](https://github.com/RailsEventStore/rails_event_store) ⭐ 1,551 | 🐛 14 | 🌐 Ruby | 📅 2026-08-26 - A gem to implement event store in Rails [:red\_circle:](https://rubygems.org/gems/rails_event_store)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,200 | 🐛 8 | 🌐 Ruby | 📅 2026-08-26 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
* [ahoy\_email](https://github.com/ankane/ahoy_email) ⭐ 1,190 | 🐛 1 | 🌐 Ruby | 📅 2026-08-17 - A tool to provide mail analytics. [:red\_circle:](https://rubygems.org/gems/ahoy_email)
...
* [activerecord-sqlserver-adapter](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 981 | 🐛 21 | 🌐 Ruby | 📅 2026-08-22 - ActiveRecord connection adapter for the SQL Server. [:red\_circle:](https://rubygems.org/gems/activerecord-sqlserver-adapter)
...
* [route\_translator](https://github.com/enriclluelles/route_translator) ⭐ 948 | 🐛 6 | 🌐 Ruby | 📅 2026-08-24 - A tool to handle route translation. [:red\_circle:](https://rubygems.org/gems/route_translator)
...
* [rubocop-rails](https://github.com/rubocop/rubocop-rails) ⭐ 876 | 🐛 189 | 🌐 Ruby | 📅 2026-08-25 - A code style checking tool. [:red\_circle:](https://rubygems.org/gems/rubocop-rails)
* [tinymce-rails](https://github.com/spohlenz/tinymce-rails) ⭐ 822 | 🐛 73 | 🌐 JavaScript | 📅 2026-07-27 - A gem to integrate Tinymce in Rails apps. [:red\_circle:](https://rubygems.org/gems/tinymce-rails)
...
* [stimulus-rails](https://github.com/hotwired/stimulus-rails) ⭐ 725 | 🐛 12 | 🌐 JavaScript | 📅 2025-03-03 - A gem to integrate Stimulus.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/stimulus-rails)
...
* [shakapacker](https://github.com/shakacode/shakapacker) ⭐ 489 | 🐛 13 | 🌐 Ruby | 📅 2026-08-25 - A gem to use webpack to manage app-like JavaScript modules in Rails. [:red\_circle:](https://rubygems.org/gems/shakapacker)
...
* [algoliasearch-rails](https://github.com/algolia/algoliasearch-rails) ⭐ 419 | 🐛 62 | 🌐 Ruby | 📅 2026-08-24 - A gem to integrate Algolia search. [:red\_circle:](https://rubygems.org/gems/algoliasearch-rails)
...
* [suspenders](https://github.com/thoughtbot/suspenders) ⭐ 4,043 | 🐛 2 | 🌐 Ruby | 📅 2026-06-19 - A Rails template with our standard defaults, ready to deploy to Heroku.
...
* [rails-templates(lewagon)](https://github.com/lewagon/rails-templates) ⭐ 680 | 🐛 3 | 🌐 Ruby | 📅 2026-04-07 - Jump start your Rails development with Le Wagon best practices.
* [rails\_api\_base](https://github.com/rootstrap/rails_api_base) ⭐ 633 | 🐛 5 | 🌐 Ruby | 📅 2026-08-21 - Rails 6 boilerplate project for JSON RESTful APIs.
...
* [nativeapptemplateapi](https://github.com/nativeapptemplate/nativeapptemplateapi) ⭐ 14 | 🐛 0 | 🌐 Ruby | 📅 2026-08-22 - A Rails 8.1 multi-tenant API backend for native iOS (Swift/SwiftUI) and Android (Kotlin/Compose) apps. Uses acts\_as\_tenant, devise\_token\_auth, Pundit, Solid Queue/Cache/Cable, and PostgreSQL (using Rails 8.1).
