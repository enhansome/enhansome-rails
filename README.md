...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 499,801 | 🐛 106 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 48,032 | 🐛 82 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,248 | 🐛 4,496 | 🌐 Ruby | 📅 2026-08-25 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,727 | 🐛 283 | 🌐 Ruby | 📅 2026-08-25 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,199 | 🐛 1,351 | 🌐 Ruby | 📅 2026-08-25 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,536 | 🐛 37 | 🌐 Ruby | 📅 2026-08-25 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,770 | 🐛 135 | 🌐 Ruby | 📅 2026-08-25 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,373 | 🐛 119 | 🌐 Ruby | 📅 2026-08-25 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,765 | 🐛 89 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,929 | 🐛 234 | 🌐 Ruby | 📅 2026-08-25 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,783 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,817 | 🐛 265 | 🌐 Ruby | 📅 2026-08-17 - A link aggregation app (using Rails 8.1). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,585 | 🐛 52 | 🌐 Ruby | 📅 2026-08-24 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
* [blackCandy](https://github.com/blackcandy-org/black_candy) ⭐ 4,403 | 🐛 33 | 🌐 Ruby | 📅 2026-08-25 - A music streaming app (using Rails 7.0).
* [feedbin](https://github.com/feedbin/feedbin) ⭐ 3,777 | 🐛 181 | 🌐 Ruby | 📅 2026-08-25 - A RSS reader app (using Rails 7.0). - [:earth\_africa:](https://feedbin.com)
* [fat-free-crm](https://github.com/fatfreecrm/fat_free_crm) ⭐ 3,628 | 🐛 73 | 🌐 Ruby | 📅 2026-08-24 - An open source, Ruby on Rails customer relationship management platform (CRM) (using Rails 6.1). - [:earth\_africa:](http://www.fatfreecrm.com/)
* [peatio](https://github.com/peatio/peatio) ⭐ 3,600 | 🐛 302 | 🌐 Ruby | 📅 2026-07-09 - A crypto currency exchange app (using Rails 4.0).
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,164 | 🐛 112 | 🌐 Ruby | 📅 2026-08-25 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [selfstarter](https://github.com/apigy/selfstarter) ⭐ 3,153 | 🐛 47 | 🌐 Ruby | 📅 2022-10-27 - A crowdfunding app (using Rails 4.0).
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,813 | 🐛 653 | 🌐 Ruby | 📅 2026-08-24 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,790 | 🐛 478 | 🌐 Ruby | 📅 2026-08-25 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,591 | 🐛 94 | 🌐 Ruby | 📅 2026-08-25 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,437 | 🐛 117 | 🌐 Ruby | 📅 2026-08-25 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,196 | 🐛 128 | 🌐 Ruby | 📅 2026-08-23 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,671 | 🐛 168 | 🌐 Ruby | 📅 2026-08-25- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [codetriage](https://github.com/codetriage/codetriage) ⭐ 1,464 | 🐛 103 | 🌐 Ruby | 📅 2026-08-02 - An open source project finder app (using Rails 7.0). - [:earth\_africa:](https://www.codetriage.com/)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,024 | 🐛 38 | 🌐 Ruby | 📅 2026-08-25 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 844 | 🐛 550 | 🌐 JavaScript | 📅 2026-08-24 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 583 | 🐛 75 | 🌐 Ruby | 📅 2026-08-25 - An inventory management system for essentials banks (using Rails 7.0). - [:earth\_africa:](https://humanessentials.app/)
* [ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 489 | 🐛 9 | 🌐 Ruby | 📅 2026-07-26 - A farm management app (using Rails 5.0).
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 476 | 🐛 387 | 🌐 Ruby | 📅 2026-08-25 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 418 | 🐛 137 | 🌐 Ruby | 📅 2026-08-25 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 474 | 🌐 Ruby | 📅 2026-08-25 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 216 | 🌐 TypeScript | 📅 2026-08-24 - Learning platform app (using Rails 6.0).
...
* [planningalerts-app](https://github.com/openaustralia/planningalerts) ⭐ 115 | 🐛 65 | 🌐 Ruby | 📅 2026-08-25 - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 33 | 🌐 Ruby | 📅 2026-08-25 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,709 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)
...
* [spree](https://github.com/spree/spree) ⭐ 15,645 | 🐛 132 | 🌐 Ruby | 📅 2026-08-25 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
...
* [cancancan](https://github.com/cancancommunity/cancancan) ⭐ 5,686 | 🐛 93 | 🌐 Ruby | 📅 2026-08-09 - A gem to handle authorization. [:red\_circle:](https://rubygems.org/gems/cancancan)
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,521 | 🐛 18 | 🌐 Ruby | 📅 2026-08-25 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,322 | 🐛 121 | 🌐 Ruby | 📅 2026-08-21 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 65 | 🌐 Ruby | 📅 2026-08-22 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 123 | 🌐 Ruby | 📅 2026-08-25 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [rails-erd](https://github.com/voormedia/rails-erd) ⭐ 4,105 | 🐛 4 | 🌐 Ruby | 📅 2026-08-14 - A gem to generate entity-relationship diagram. [:red\_circle:](https://rubygems.org/gems/rails-erd)
...
* [view\_component](https://github.com/ViewComponent/view_component) ⭐ 3,569 | 🐛 4 | 🌐 Ruby | 📅 2026-08-24 - A gem to introduce view components. [:red\_circle:](https://rubygems.org/gems/view_component)
...
* [solid\_queue](https://github.com/basecamp/solid_queue) ⭐ 2,488 | 🐛 40 | 🌐 Ruby | 📅 2026-08-23 - A gem to Database-backed Active Job backend [:red\_circle:](https://rubygems.org/gems/solid_queue)
...
* [avo](https://github.com/avo-hq/avo) ⭐ 1,796 | 🐛 194 | 🌐 Ruby | 📅 2026-08-24 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [aggregate\_root](https://github.com/RailsEventStore/rails_event_store/tree/master/aggregate_root) ⭐ 1,551 | 🐛 14 | 🌐 Ruby | 📅 2026-08-23 - A gem to handle event sourcing. [:red\_circle:](https://rubygems.org/gems/aggregate_root)
* [rails\_event\_store](https://github.com/RailsEventStore/rails_event_store) ⭐ 1,551 | 🐛 14 | 🌐 Ruby | 📅 2026-08-23 - A gem to implement event store in Rails [:red\_circle:](https://rubygems.org/gems/rails_event_store)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,200 | 🐛 9 | 🌐 Ruby | 📅 2026-08-24 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
...
* [sprockets](https://github.com/rails/sprockets) ⭐ 985 | 🐛 90 | 🌐 Ruby | 📅 2026-08-18 - A gem to compile & serve web assets. [:red\_circle:](https://rubygems.org/gems/sprockets)
...
* [rubocop-rails](https://github.com/rubocop/rubocop-rails) ⭐ 876 | 🐛 190 | 🌐 Ruby | 📅 2026-08-22 - A code style checking tool. [:red\_circle:](https://rubygems.org/gems/rubocop-rails)
...
* [shakapacker](https://github.com/shakacode/shakapacker) ⭐ 489 | 🐛 14 | 🌐 Ruby | 📅 2026-08-25 - A gem to use webpack to manage app-like JavaScript modules in Rails. [:red\_circle:](https://rubygems.org/gems/shakapacker)
...
* [suspenders](https://github.com/thoughtbot/suspenders) ⭐ 4,044 | 🐛 2 | 🌐 Ruby | 📅 2026-06-19 - A Rails template with our standard defaults, ready to deploy to Heroku.
