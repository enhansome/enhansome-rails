...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 499,693 | 🐛 106 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 48,015 | 🐛 82 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,246 | 🐛 4,495 | 🌐 Ruby | 📅 2026-08-25 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,723 | 🐛 288 | 🌐 Ruby | 📅 2026-08-25 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,178 | 🐛 1,350 | 🌐 Ruby | 📅 2026-08-25 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,536 | 🐛 37 | 🌐 Ruby | 📅 2026-08-25 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,771 | 🐛 134 | 🌐 Ruby | 📅 2026-08-24 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,372 | 🐛 118 | 🌐 Ruby | 📅 2026-08-17 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,766 | 🐛 89 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,923 | 🐛 236 | 🌐 Ruby | 📅 2026-08-25 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,784 | 🐛 467 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,815 | 🐛 265 | 🌐 Ruby | 📅 2026-08-17 - A link aggregation app (using Rails 8.1). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,585 | 🐛 51 | 🌐 Ruby | 📅 2026-08-24 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
* [blackCandy](https://github.com/blackcandy-org/black_candy) ⭐ 4,403 | 🐛 35 | 🌐 Ruby | 📅 2026-08-13 - A music streaming app (using Rails 7.0).
* [feedbin](https://github.com/feedbin/feedbin) ⭐ 3,776 | 🐛 181 | 🌐 Ruby | 📅 2026-08-19 - A RSS reader app (using Rails 7.0). - [:earth\_africa:](https://feedbin.com)
* [fat-free-crm](https://github.com/fatfreecrm/fat_free_crm) ⭐ 3,627 | 🐛 73 | 🌐 Ruby | 📅 2026-08-24 - An open source, Ruby on Rails customer relationship management platform (CRM) (using Rails 6.1). - [:earth\_africa:](http://www.fatfreecrm.com/)
* [peatio](https://github.com/peatio/peatio) ⭐ 3,600 | 🐛 302 | 🌐 Ruby | 📅 2026-07-09 - A crypto currency exchange app (using Rails 4.0).
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,164 | 🐛 114 | 🌐 Ruby | 📅 2026-08-25 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
...
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,789 | 🐛 480 | 🌐 Ruby | 📅 2026-08-24 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,591 | 🐛 96 | 🌐 Ruby | 📅 2026-08-25 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,437 | 🐛 116 | 🌐 Ruby | 📅 2026-08-25 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,198 | 🐛 128 | 🌐 Ruby | 📅 2026-08-23 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [multiwoven](https://github.com/Multiwoven/multiwoven) ⭐ 1,671 | 🐛 170 | 🌐 Ruby | 📅 2026-08-25- The open-source reverse ETL, data activation platform for modern data teams. (using Rails 7.1.1) - [🌍](https://www.multiwoven.com/)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,024 | 🐛 38 | 🌐 Ruby | 📅 2026-08-24 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 844 | 🐛 549 | 🌐 JavaScript | 📅 2026-08-24 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 418 | 🐛 135 | 🌐 Ruby | 📅 2026-08-24 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 470 | 🌐 Ruby | 📅 2026-08-24 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [vglist](https://github.com/connorshea/vglist) ⭐ 157 | 🐛 70 | 🌐 Ruby | 📅 2026-08-24 - A video game library tracking web app (using Rails 7.0). - [:earth\_africa:](https://vglist.co/)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 32 | 🌐 Ruby | 📅 2026-08-24 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,709 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-25 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)

> Other gems that can be used with Rails

* [devise](https://github.com/heartcombo/devise) ⭐ 24,360 | 🐛 231 | 🌐 Ruby | 📅 2026-06-22 - A gem to provide authentication. [:red\_circle:](https://rubygems.org/gems/devise)
* [spree](https://github.com/spree/spree) ⭐ 15,642 | 🐛 134 | 🌐 Ruby | 📅 2026-08-25 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
* [activeadmin](https://github.com/activeadmin/activeadmin) ⭐ 9,705 | 🐛 30 | 🌐 Ruby | 📅 2026-08-25 - A gem to provide admin panel. [:red\_circle:](https://rubygems.org/gems/activeadmin)
* [carrierwave](https://github.com/carrierwaveuploader/carrierwave) ⭐ 8,780 | 🐛 62 | 🌐 Ruby | 📅 2026-08-23 - A gem to handle file uploads. [:red\_circle:](https://rubygems.org/gems/carrierwave)
...
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,521 | 🐛 19 | 🌐 Ruby | 📅 2026-08-24 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,323 | 🐛 121 | 🌐 Ruby | 📅 2026-08-21 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 64 | 🌐 Ruby | 📅 2026-08-22 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 122 | 🌐 Ruby | 📅 2026-08-25 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [activerecord-import](https://github.com/zdennis/activerecord-import) ⭐ 4,155 | 🐛 44 | 🌐 Ruby | 📅 2026-08-24 - A gem to handle bulk data insertion using ActiveRecord. [:red\_circle:](https://rubygems.org/gems/activerecord-import)
...
* [premailer-rails](https://github.com/fphilipe/premailer-rails) ⭐ 1,764 | 🐛 14 | 🌐 Ruby | 📅 2024-06-17 - A gem to handle email styling. [:red\_circle:](https://rubygems.org/gems/premailer-rails)
...
* [breadcrumbs\_on\_rails](https://github.com/weppos/breadcrumbs_on_rails) ⭐ 953 | 🐛 6 | 🌐 Ruby | 📅 2024-12-11 - A gem to create & manage breadcrumbs-style navigation. [:red\_circle:](https://rubygems.org/gems/breadcrumbs_on_rails)
...
* [stimulus-rails](https://github.com/hotwired/stimulus-rails) ⭐ 726 | 🐛 11 | 🌐 JavaScript | 📅 2025-03-03 - A gem to integrate Stimulus.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/stimulus-rails)
...
* [shakapacker](https://github.com/shakacode/shakapacker) ⭐ 490 | 🐛 14 | 🌐 Ruby | 📅 2026-08-25 - A gem to use webpack to manage app-like JavaScript modules in Rails. [:red\_circle:](https://rubygems.org/gems/shakapacker)
...
* [activerecord-typedstore](https://github.com/byroot/activerecord-typedstore) ⭐ 468 | 🐛 24 | 🌐 Ruby | 📅 2024-02-28 - A gem to implement `ActiveRecord::Store` with type definition. [:red\_circle:](https://rubygems.org/gems/activerecord-typedstore)
...
* [reform-rails](https://github.com/trailblazer/reform-rails) ⭐ 101 | 🐛 25 | 🌐 Ruby | 📅 2025-12-18 - A gem to wrap Reform gem, a form validation tool, with Rails app. [:red\_circle:](https://rubygems.org/gems/reform-rails)
...
* [rails-templates(nimblehq)](https://github.com/nimblehq/rails-templates) ⭐ 105 | 🐛 32 | 🌐 Ruby | 📅 2026-07-10 - Our optimized Rails templates used in our projects.
