...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 496,371 | 🐛 100 | 📅 2026-06-30
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 47,583 | 🐛 75 | 📅 2026-05-08
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,212 | 🐛 4,491 | 🌐 Ruby | 📅 2026-08-16 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,659 | 🐛 235 | 🌐 Ruby | 📅 2026-08-15 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 35,901 | 🐛 1,339 | 🌐 Ruby | 📅 2026-08-16 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,530 | 🐛 37 | 🌐 Ruby | 📅 2026-08-16 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,767 | 🐛 125 | 🌐 Ruby | 📅 2026-08-16 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,262 | 🐛 117 | 🌐 Ruby | 📅 2026-08-11 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,737 | 🐛 90 | 🌐 Ruby | 📅 2026-08-05 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,858 | 🐛 219 | 🌐 Ruby | 📅 2026-08-16 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
* [diaspora](https://github.com/diaspora/diaspora) ⭐ 13,659 | 🐛 425 | 🌐 Ruby | 📅 2026-07-28 - A social networking app - using Rails 6.1 - [:earth\_africa:](https://diasporafoundation.org)
* [canvas-lms](https://github.com/instructure/canvas-lms) ⭐ 6,774 | 🐛 466 | 🌐 Ruby | 📅 2026-04-30 - A learning management app.
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,815 | 🐛 260 | 🌐 Ruby | 📅 2026-08-15 - A link aggregation app (using Rails 7.0). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,573 | 🐛 61 | 🌐 Ruby | 📅 2026-08-12 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
* [blackCandy](https://github.com/blackcandy-org/black_candy) ⭐ 4,397 | 🐛 37 | 🌐 Ruby | 📅 2026-08-13 - A music streaming app (using Rails 7.0).
* [feedbin](https://github.com/feedbin/feedbin) ⭐ 3,772 | 🐛 181 | 🌐 Ruby | 📅 2026-08-14 - A RSS reader app (using Rails 7.0). - [:earth\_africa:](https://feedbin.com)
...
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,153 | 🐛 127 | 🌐 Ruby | 📅 2026-08-14 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [selfstarter](https://github.com/apigy/selfstarter) ⭐ 3,153 | 🐛 49 | 🌐 Ruby | 📅 2022-10-27 - A crowdfunding app (using Rails 4.0).
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,807 | 🐛 654 | 🌐 Ruby | 📅 2026-08-13 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,783 | 🐛 492 | 🌐 Ruby | 📅 2026-08-06 - A taggable image board app (using Rails 7.0).
...
* [helpy](https://github.com/helpyio/helpy) ⭐ 2,478 | 🐛 230 | 🌐 Ruby | 📅 2023-03-08 - A customer support app (using Rails 4.2). - [:earth\_africa:](https://helpy.io/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,438 | 🐛 110 | 🌐 Ruby | 📅 2026-08-14 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,179 | 🐛 129 | 🌐 Ruby | 📅 2026-08-14 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [publify](https://github.com/publify/publify) ⭐ 1,857 | 🐛 84 | 🌐 Less | 📅 2026-08-10 - A blogging app (using Rails 6.1).
...
* [codetriage](https://github.com/codetriage/codetriage) ⭐ 1,462 | 🐛 103 | 🌐 Ruby | 📅 2026-08-02 - An open source project finder app (using Rails 7.0). - [:earth\_africa:](https://www.codetriage.com/)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,022 | 🐛 43 | 🌐 Ruby | 📅 2026-08-14 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 844 | 🐛 549 | 🌐 JavaScript | 📅 2026-08-15 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 476 | 🐛 389 | 🌐 Ruby | 📅 2026-08-16 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 419 | 🐛 129 | 🌐 Ruby | 📅 2026-08-14 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 32 | 🌐 Ruby | 📅 2026-08-16 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 474 | 🌐 Ruby | 📅 2026-08-15 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 217 | 🌐 TypeScript | 📅 2026-08-16 - Learning platform app (using Rails 6.0).
* [vglist](https://github.com/connorshea/vglist) ⭐ 157 | 🐛 68 | 🌐 Ruby | 📅 2026-08-15 - A video game library tracking web app (using Rails 7.0). - [:earth\_africa:](https://vglist.co/)
...
* [beatstream](https://github.com/Darep/Beatstream) ⭐ 124 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-15 - A music streaming app - using Rails 3.2
* [planningalerts-app](https://github.com/openaustralia/planningalerts) ⭐ 115 | 🐛 46 | 🌐 Ruby | 📅 2026-08-15 - A planned applications tracking app (using Rails 6.1). - [:earth\_africa:](https://www.planningalerts.org.au)
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,685 | 🐛 1,593 | 🌐 Ruby | 📅 2026-08-16 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)
...
* [spree](https://github.com/spree/spree) ⭐ 15,624 | 🐛 132 | 🌐 Ruby | 📅 2026-08-16 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
...
* [simple\_form](https://github.com/heartcombo/simple_form) ⭐ 8,226 | 🐛 37 | 🌐 Ruby | 📅 2026-04-01 - A gem to handle forms. [:red\_circle:](https://rubygems.org/gems/simple_form)
...
* [searchkick](https://github.com/ankane/searchkick) ⭐ 6,720 | 🐛 9 | 🌐 Ruby | 📅 2026-08-15 - A gem to provide search functionality. [:red\_circle:](https://rubygems.org/gems/searchkick)
...
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,518 | 🐛 17 | 🌐 Ruby | 📅 2026-08-13 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 123 | 🌐 Ruby | 📅 2026-08-16 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
...
* [turbo-rails](https://github.com/hotwired/turbo-rails) ⭐ 2,388 | 🐛 127 | 🌐 Ruby | 📅 2026-07-01 - A gem to integrate Turbo.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/turbo-rails)
...
* [avo](https://github.com/avo-hq/avo) ⭐ 1,797 | 🐛 236 | 🌐 Ruby | 📅 2026-08-15 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [lockbox](https://github.com/ankane/lockbox) ⭐ 1,605 | 🐛 5 | 🌐 Ruby | 📅 2026-04-09 - A gem to deal with encryption. [:red\_circle:](https://rubygems.org/gems/lockbox)
...
* [rodauth-rails](https://github.com/janko/rodauth-rails) ⭐ 758 | 🐛 1 | 🌐 HTML | 📅 2026-08-07 - A gem to wrap Rodauth, an authentication handler, for Rails apps. [:red\_circle:](https://rubygems.org/gems/rodauth-rails)
* [stimulus-rails](https://github.com/hotwired/stimulus-rails) ⭐ 725 | 🐛 11 | 🌐 JavaScript | 📅 2025-03-03 - A gem to integrate Stimulus.js in Rails apps. [:red\_circle:](https://rubygems.org/gems/stimulus-rails)
...
* [shakapacker](https://github.com/shakacode/shakapacker) ⭐ 490 | 🐛 24 | 🌐 Ruby | 📅 2026-08-11 - A gem to use webpack to manage app-like JavaScript modules in Rails. [:red\_circle:](https://rubygems.org/gems/shakapacker)
* [tidewave](https://github.com/tidewave-ai/tidewave_rails) ⭐ 475 | 🐛 3 | 🌐 Ruby | 📅 2026-08-16 - MCP server for agentic Rails development, runtime-level tools for your agent to talk to your running app. [:red\_circle:](https://rubygems.org/gems/tidewave)
...
* [image\_optim\_rails](https://github.com/toy/image_optim_rails) ⭐ 58 | 🐛 3 | 🌐 Ruby | 📅 2026-07-20 - A gem to handle image optimization. [:red\_circle:](https://rubygems.org/gems/image_optim_rails)
