...
> A curated list of awesome things related to Ruby on Rails [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome#readme) ⭐ 501,974 | 🐛 105 | 📅 2026-08-21
...
> Tip: You can find list of remote job boards including Rails jobs on [awesome-remote-job](https://github.com/lukasz-madon/awesome-remote-job#job-boards) ⭐ 48,305 | 🐛 86 | 📅 2026-08-16
...
* [mastodon](https://github.com/mastodon/mastodon) ⭐ 50,260 | 🐛 4,514 | 🌐 Ruby | 📅 2026-09-01 - A microblogging app (using Rails 6.1). - [:earth\_africa:](https://mastodon.social/about)
* [discourse](https://github.com/discourse/discourse) ⭐ 47,767 | 🐛 264 | 🌐 Ruby | 📅 2026-09-01 - A platform for community discussion (using Rails 7.0). - [:earth\_africa:](https://try.discourse.org/)
* [chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,370 | 🐛 1,349 | 🌐 Ruby | 📅 2026-09-01 - A simple and elegant live chat software (using Rails 6.1).
* [gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,549 | 🐛 36 | 🌐 Ruby | 📅 2026-09-01 - A code collaboration app (using Rails 6.1).
* [forem](https://github.com/forem/forem) ⭐ 22,774 | 🐛 132 | 🌐 Ruby | 📅 2026-09-01 - Social platform app specialized for web development (using Rails 7.0). - [:earth\_africa:](https://www.forem.com)
* [docuseal](https://github.com/docusealco/docuseal) ⭐ 18,412 | 🐛 122 | 🌐 Ruby | 📅 2026-08-31 - A platform to fill and sign digital documents (using Rails 7.0). - [:earth\_africa:](https://www.docuseal.co/)
* [postal](https://github.com/postalserver/postal) ⭐ 16,778 | 🐛 95 | 🌐 Ruby | 📅 2026-08-18 - A mail delivery platform (using Rails 5.2).
* [openproject](https://github.com/opf/openproject) ⭐ 15,989 | 🐛 228 | 🌐 Ruby | 📅 2026-09-01 - A project management app (using Rails 7.0). - [:earth\_africa:](https://www.openproject.org)
...
* [lobsters](https://github.com/lobsters/lobsters) ⭐ 4,821 | 🐛 265 | 🌐 Ruby | 📅 2026-08-17 - A link aggregation app (using Rails 8.1). - [:earth\_africa:](https://lobste.rs)
* [theodinproject](https://github.com/TheOdinProject/theodinproject) ⭐ 4,600 | 🐛 52 | 🌐 Ruby | 📅 2026-08-31 - A teaching & learning platform (using Rails 6.1). - [:earth\_africa:](https://www.theodinproject.com/)
* [blackCandy](https://github.com/blackcandy-org/black_candy) ⭐ 4,407 | 🐛 33 | 🌐 Ruby | 📅 2026-09-01 - A music streaming app (using Rails 7.0).
* [feedbin](https://github.com/feedbin/feedbin) ⭐ 3,779 | 🐛 181 | 🌐 Ruby | 📅 2026-08-25 - A RSS reader app (using Rails 7.0). - [:earth\_africa:](https://feedbin.com)
...
* [passwordPusher](https://github.com/pglombardo/PasswordPusher) ⭐ 3,171 | 🐛 109 | 🌐 Ruby | 📅 2026-09-01 - A password delivery app (using Rails 6.1). - [:earth\_africa:](https://pwpush.com)
* [selfstarter](https://github.com/apigy/selfstarter) ⭐ 3,154 | 🐛 47 | 🌐 Ruby | 📅 2022-10-27 - A crowdfunding app (using Rails 4.0).
* [openstreetmap-website](https://github.com/openstreetmap/openstreetmap-website) ⭐ 2,818 | 🐛 659 | 🌐 Ruby | 📅 2026-08-31 - A map viewing app (using Rails 7.0). - [:earth\_africa:](https://www.openstreetmap.org)
* [danbooru](https://github.com/danbooru/danbooru) ⭐ 2,795 | 🐛 468 | 🌐 Ruby | 📅 2026-08-31 - A taggable image board app (using Rails 7.0).
* [loomio](https://github.com/loomio/loomio) ⭐ 2,593 | 🐛 101 | 🌐 Ruby | 📅 2026-09-01 - A collaborative decision-making app (using Rails 6.1). - [:earth\_africa:](https://www.loomio.com/)
...
* [rubygems.org](https://github.com/rubygems/rubygems.org) ⭐ 2,439 | 🐛 114 | 🌐 Ruby | 📅 2026-09-01 - A gem hosting platform (using Rails 7.0). - [:earth\_africa:](https://rubygems.org)
...
* [otwarchive](https://github.com/otwcode/otwarchive) ⭐ 2,207 | 🐛 138 | 🌐 Ruby | 📅 2026-09-01 - A social networking app for fans - using Rails 6.0 - [:earth\_africa:](https://archiveofourown.org)
...
* [whitehall](https://github.com/alphagov/whitehall) ⭐ 1,026 | 🐛 39 | 🌐 Ruby | 📅 2026-09-01 - A content management app used by UK government - using Rails 7.0
  [Back to top][link_toc]
...
* [FAE](https://github.com/wearefine/fae/) ⭐ 850 | 🐛 13 | 🌐 Ruby | 📅 2026-08-26 - A modern CMS developed by FINE (using Rails 5.2)
* [inaturalist](https://github.com/inaturalist/inaturalist) ⭐ 849 | 🐛 548 | 🌐 JavaScript | 📅 2026-09-01 - A community app for nature and related stuff (using Rails 6.1). - [:earth\_africa:](https://www.inaturalist.org)
...
* [human-essentials](https://github.com/rubyforgood/human-essentials) ⭐ 590 | 🐛 71 | 🌐 Ruby | 📅 2026-09-01 - An inventory management system for essentials banks (using Rails 7.0). - [:earth\_africa:](https://humanessentials.app/)
* [ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 489 | 🐛 9 | 🌐 Ruby | 📅 2026-08-27 - A farm management app (using Rails 5.0).
* [hitobito](https://github.com/hitobito/hitobito) ⭐ 477 | 🐛 386 | 🌐 Ruby | 📅 2026-09-01 - An event organization app (using Rails 6.1). - [:earth\_africa:](https://hitobito.com/en)
* [growstuff](https://github.com/Growstuff/growstuff) ⭐ 473 | 🐛 123 | 🌐 Ruby | 📅 2026-08-31 - A data management app for food gardeners (using Rails 6.1). - [:earth\_africa:](https://www.growstuff.org/)
...
* [alaveteli](https://github.com/mysociety/alaveteli) ⭐ 418 | 🐛 141 | 🌐 Ruby | 📅 2026-08-31 - A platform for making public freedom of information requests - using Rails 7.0 - [:earth\_africa:](https://alaveteli.org)
...
* [bike\_index](https://github.com/bikeindex/bike_index) ⭐ 308 | 🐛 27 | 🌐 Ruby | 📅 2026-09-01 - A bike registry tracking app (using Rails 6.0). - [:earth\_africa:](https://bikeindex.org)
...
* [fromthepage](https://github.com/benwbrum/fromthepage) ⭐ 185 | 🐛 469 | 🌐 Ruby | 📅 2026-08-31 - A wiki-like app for crowdsourcing transcription of handwritten documents (using Rails 6.0). - [:earth\_africa:](https://www.fromthepage.com/)
...
* [coursemology2](https://github.com/Coursemology/coursemology2) ⭐ 157 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-01 - Learning platform app (using Rails 6.0).
...
* [somleng](https://github.com/somleng/somleng) ⭐ 97 | 🐛 7 | 🌐 Ruby | 📅 2026-08-31 - An Open Source Communications-Platform-as-a-Service (CPaaS) and Telco-as-a-service (TaaS). (using Rails 7.1). - [:earth\_africa:](https://www.somleng.org)
...
* [airCasting](https://github.com/HabitatMap/AirCasting) ⭐ 64 | 🐛 33 | 🌐 Ruby | 📅 2026-09-01 - A platform for recording, mapping, and sharing health and environmental data using your smartphone (using Rails 6.1). - [:earth\_africa:](https://www.habitatmap.org/aircasting)
...
* [scholarsphere](https://github.com/psu-libraries/scholarsphere) ⭐ 13 | 🐛 140 | 🌐 Ruby | 📅 2026-08-14 - A digital assets management app - using Rails 6.1
...
* [actioncable](https://github.com/rails/rails/tree/main/actioncable) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to integrate websocket with a Rails app [:red\_circle:](https://rubygems.org/gems/actioncable) - [Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html)
* [actionmailbox](https://github.com/rails/rails/tree/main/actionmailbox) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to handle incoming emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailbox) - [Action Mailbox Basics](https://guides.rubyonrails.org/action_mailbox_basics.html)
* [actionmailer](https://github.com/rails/rails/tree/main/actionmailer) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to compose, deliver & test emails within a Rails app [:red\_circle:](https://rubygems.org/gems/actionmailer) - [Action Mailer Basics](https://guides.rubyonrails.org/action_mailer_basics.html)
* [actionpack](https://github.com/rails/rails/tree/main/actionpack) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to manage requests & responses within a Rails app [:red\_circle:](https://rubygems.org/gems/actionpack)
* [actiontext](https://github.com/rails/rails/tree/main/actiontext) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to integrate rich text editor into a Rails app [:red\_circle:](https://rubygems.org/gems/actiontext) - [Action Text Overview](https://guides.rubyonrails.org/action_text_overview.html)
* [actionview](https://github.com/rails/rails/tree/main/actionview) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to handle view templates within a Rails app [:red\_circle:](https://rubygems.org/gems/actionview) - [Action View Overview](https://guides.rubyonrails.org/action_view_overview.html)
* [activejob](https://github.com/rails/rails/tree/main/activejob) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to handle background jobs within a Rails app [:red\_circle:](https://rubygems.org/gems/activejob) - [Active Job Basics](https://guides.rubyonrails.org/active_job_basics.html)
* [activemodel](https://github.com/rails/rails/tree/main/activemodel) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to define a set of interfaces to use in model classes within a Rails app [:red\_circle:](https://rubygems.org/gems/activemodel) - [Active Model Basics](https://guides.rubyonrails.org/active_model_basics.html)
* [activerecord](https://github.com/rails/rails/tree/main/activerecord) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to connect model classes with relational databases within a Rails app [:red\_circle:](https://rubygems.org/gems/activerecord) - [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html)
* [activestorage](https://github.com/rails/rails/tree/main/activestorage) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to handle file uploads to cloud storage providers within a Rails app [:red\_circle:](https://rubygems.org/gems/activestorage) - [Active Storage Overview](https://guides.rubyonrails.org/active_storage_overview.html)
* [activesupport](https://github.com/rails/rails/tree/main/activesupport) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to provide some extensions to support a Rails app [:red\_circle:](https://rubygems.org/gems/activesupport) - [Active Support Core Extensions](https://guides.rubyonrails.org/active_support_core_extensions.html)
* [railties](https://github.com/rails/rails/tree/main/railties) ⭐ 58,748 | 🐛 1,606 | 🌐 Ruby | 📅 2026-09-01 - A gem to handle gems & engines used in a Rails app to work together [:red\_circle:](https://rubygems.org/gems/railties)
...
* [spree](https://github.com/spree/spree) ⭐ 15,658 | 🐛 133 | 🌐 Ruby | 📅 2026-09-01 - An open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/spree)
...
* [kaminari](https://github.com/kaminari/kaminari) ⭐ 8,670 | 🐛 74 | 🌐 Ruby | 📅 2026-02-20 - A gem to provide pagination. [:red\_circle:](https://rubygems.org/gems/kaminari)
...
* [rails\_admin](https://github.com/railsadminteam/rails_admin) ⭐ 7,956 | 🐛 202 | 🌐 Ruby | 📅 2026-08-30 - A gem to create & manage admin panel for Rails app. [:red\_circle:](https://rubygems.org/gems/rails_admin)
* [brakeman](https://github.com/presidentbeef/brakeman) ⭐ 7,266 | 🐛 116 | 🌐 Ruby | 📅 2026-08-13 - A gem to scan code against security vulnerabilities. [:red\_circle:](https://rubygems.org/gems/brakeman)
...
* [doorkeeper](https://github.com/doorkeeper-gem/doorkeeper) ⭐ 5,523 | 🐛 19 | 🌐 Ruby | 📅 2026-08-29 - A gem to introduce OAuth2 provider functionality. [:red\_circle:](https://rubygems.org/gems/doorkeeper)
* [solidus](https://github.com/solidusio/solidus) ⭐ 5,325 | 🐛 108 | 🌐 Ruby | 📅 2026-08-31 - A fork of Spree gem, an open source e-commerce platform. [:red\_circle:](https://rubygems.org/gems/solidus)
...
* [rspec-rails](https://github.com/rspec/rspec-rails) ⭐ 5,271 | 🐛 67 | 🌐 Ruby | 📅 2026-09-01 - A testing framework. [:red\_circle:](https://rubygems.org/gems/rspec-rails)
...
* [react\_on\_rails](https://github.com/shakacode/react_on_rails) ⭐ 5,190 | 🐛 116 | 🌐 Ruby | 📅 2026-09-01 - A gem to integrate React.js with Rails app with SSR. [:red\_circle:](https://rubygems.org/gems/react_on_rails)
* [annotate](https://github.com/ctran/annotate_models) ⭐ 4,481 | 🐛 144 | 🌐 Ruby | 📅 2024-08-05 - A gem to annotate rails classes with schema & routes info. [:red\_circle:](https://rubygems.org/gems/annotate)
...
* [rails-erd](https://github.com/voormedia/rails-erd) ⭐ 4,105 | 🐛 1 | 🌐 Ruby | 📅 2026-08-27 - A gem to generate entity-relationship diagram. [:red\_circle:](https://rubygems.org/gems/rails-erd)
...
* [scenic](https://github.com/scenic-views/scenic) ⭐ 3,625 | 🐛 32 | 🌐 Ruby | 📅 2026-06-29 - A gem to manage database views. [:red\_circle:](https://rubygems.org/gems/scenic)
...
* [view\_component](https://github.com/ViewComponent/view_component) ⭐ 3,567 | 🐛 1 | 🌐 Ruby | 📅 2026-08-25 - A gem to introduce view components. [:red\_circle:](https://rubygems.org/gems/view_component)
...
* [good\_job](https://github.com/bensheldon/good_job) ⭐ 2,992 | 🐛 128 | 🌐 Ruby | 📅 2026-09-01 - A gem to provide Postgres-based ActiveJob backend. [:red\_circle:](https://rubygems.org/gems/good_job)
...
* [apipie-rails](https://github.com/apipie/apipie-rails) ⭐ 2,507 | 🐛 233 | 🌐 Ruby | 📅 2026-08-31 - A REST API documentation tool. [:red\_circle:](https://rubygems.org/gems/apipie-rails)
...
* [money-rails](https://github.com/RubyMoney/money-rails) ⭐ 1,889 | 🐛 15 | 🌐 Ruby | 📅 2026-07-06 - A gem to integrate Money gem in Rails apps. [:red\_circle:](https://rubygems.org/gems/money-rails)
* [avo](https://github.com/avo-hq/avo) ⭐ 1,799 | 🐛 194 | 🌐 Ruby | 📅 2026-09-01 - Configuration-based, no-maintenance, extendable Ruby on Rails admin panel. [rubygems](https://rubygems.org/gems/avo)
...
* [aggregate\_root](https://github.com/RailsEventStore/rails_event_store/tree/master/aggregate_root) ⭐ 1,552 | 🐛 16 | 🌐 Ruby | 📅 2026-08-31 - A gem to handle event sourcing. [:red\_circle:](https://rubygems.org/gems/aggregate_root)
* [rails\_event\_store](https://github.com/RailsEventStore/rails_event_store) ⭐ 1,552 | 🐛 16 | 🌐 Ruby | 📅 2026-08-31 - A gem to implement event store in Rails [:red\_circle:](https://rubygems.org/gems/rails_event_store)
...
* [alba](https://github.com/okuramasafumi/alba) ⭐ 1,200 | 🐛 7 | 🌐 Ruby | 📅 2026-09-01 - A JSON serializer for Ruby, JRuby, and TruffleRuby. [:red\_circle:](https://rubygems.org/gems/alba)
...
* [activerecord-sqlserver-adapter](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 981 | 🐛 22 | 🌐 Ruby | 📅 2026-08-31 - ActiveRecord connection adapter for the SQL Server. [:red\_circle:](https://rubygems.org/gems/activerecord-sqlserver-adapter)
...
* [rubocop-rails](https://github.com/rubocop/rubocop-rails) ⭐ 875 | 🐛 189 | 🌐 Ruby | 📅 2026-08-25 - A code style checking tool. [:red\_circle:](https://rubygems.org/gems/rubocop-rails)
...
* [shakapacker](https://github.com/shakacode/shakapacker) ⭐ 489 | 🐛 20 | 🌐 Ruby | 📅 2026-08-30 - A gem to use webpack to manage app-like JavaScript modules in Rails. [:red\_circle:](https://rubygems.org/gems/shakapacker)
...
* [pgcli-rails](https://github.com/mattbrictson/pgcli-rails) ⭐ 35 | 🐛 0 | 🌐 Ruby | 📅 2026-08-01 - A replacement of `rails:dbconsole` command to manage Postgresql. [:red\_circle:](https://rubygems.org/gems/pgcli-rails)
